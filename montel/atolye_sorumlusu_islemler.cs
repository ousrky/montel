...
namespace montel
{
    public partial class atolye_sorumlusu_islemler : Form
    {
        public atolye_sorumlusu_islemler()
        {
            InitializeComponent();
        }
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                OleDbCommand sorumlu_ekle = new OleDbCommand("delete from atolye_sorumlusu where kullanici_adi='" + comboBoxEdit1.Text + "'", baglanti);
                ...
                MessageBox.Show("Atölye sorumlusu başarıyla silinmiştir.", "SORUMLU SİLİNDİ", MessageBoxButtons.OK, MessageBoxIcon.Information);

                OleDbCommand verileri_ekle = new OleDbCommand("SELECT adi AS[ADI],soyadi AS[SOYADI],kullanici_adi AS[KULLANICI ADI],sifre AS[ŞİFRE] from atolye_sorumlusu", baglanti);
                ...
                comboBoxEdit1.Text = "";
                OleDbCommand satis_oku = new OleDbCommand("select * from atolye_sorumlusu", baglanti);
        ...
        private void simpleButton3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    baglanti.Open();
                    OleDbCommand sorumlu_guncelle = new OleDbCommand("update atolye_sorumlusu  set adi='" + textEdit5.Text + "',soyadi='" + textEdit6.Text + "',kullanici_adi='" + textEdit7.Text + "',sifre='" + textEdit8.Text + "' where kullanici_adi='" + comboBoxEdit2.Text + "'", baglanti);
                    ...
                    MessageBox.Show("Atölye sorumlusu başarıyla güncellenmiştir.", "SORUMLU BAŞARIYLA GÜNCELLENDİ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    baglanti.Close();
        ...
        private void atolye_sorumlusu_islemler_Load(object sender, EventArgs e)
        {
            baglanti.Open();
            OleDbCommand atolye_oku = new OleDbCommand("select * from atolye_sorumlusu", baglanti);
        ...
        private void comboBoxEdit2_EditValueChanged(object sender, EventArgs e)
        {
            ...
            OleDbCommand atolye_oku = new OleDbCommand("select * from atolye_sorumlusu where kullanici_adi='" + comboBoxEdit2.Text + "'", baglanti);
            OleDbDataReader oku = atolye_oku.ExecuteReader();
            while (oku.Read())
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (cevap == DialogResult.Yes)
                    {
                        ...
                        if (kontrol == false)
                        {
                            OleDbCommand sorumlu_ekle = new OleDbCommand("insert into atolye_sorumlusu(adi,soyadi,kullanici_adi,sifre) values ('" + textEdit1.Text + "','" + textEdit2.Text + "','" + textEdit3.Text + "','" + textEdit4.Text + "')", baglanti);
                            sorumlu_ekle.ExecuteNonQuery();

                            OleDbCommand giris_ekle = new OleDbCommand("insert into giris_bilgiler(kullanici_adi,sifre,yetki) values ('"+ textEdit3.Text + "','" + textEdit4.Text + "','Atölye Sorumlusu')", baglanti);
                            giris_ekle.ExecuteNonQuery();

                            MessageBox.Show("Atölye sorumlusu başarıyla eklenilmiştir.", "SORUMLU EKLENİLDİ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            ...
                            OleDbCommand atolye_oku_tekrar = new OleDbCommand("select * from atolye_sorumlusu", baglanti);
                            OleDbDataReader oku_tekrar = atolye_oku_tekrar.ExecuteReader();
